...
It might be easiest to simply look at some of our example configurations in the [config dir](https://github.com/autobot/autobot/tree/main/config).
...
::: autobot.agent.agents.RetryAgentConfig

::: autobot.agent.agents.DefaultAgentConfig